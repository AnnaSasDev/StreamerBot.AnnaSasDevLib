...
public static class InputParsingService {
    ...
    // Methods
    // -----------------------------------------------------------------------------------------------------------------
    public static bool TryGetInput(int index, [NotNullWhen(true)] out string? output) {
        return CphService.TryGetArg($"{ArgumentNamePrefix}{index}", out output);
    }
    ...
    public static int GetAmountOfArguments() {
        return CphService.TryGetArg(ArgumentNameAmountOfArguments, out int? amountOfArguments) 
